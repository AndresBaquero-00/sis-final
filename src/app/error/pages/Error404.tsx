    ...
    return (
        <main className="error404">
            <div className="error404__content">
                <h1 className="error404__title">Sorry, page not found!</h1>
                ...
                <div className="error404__image">
                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 480 360">
                        ...
                        <path fill="#FFC107" d="M111.109 140.247c24.644 0 44.623-19.979 44.623-44.624 0-24.645-19.979-44.623-44.623-44.623-24.645 0-44.624 19.978-44.624 44.623 0 24.645 19.979 44.624 44.624 44.624z" opacity="0.15"></path><path fill="url(#SUN)" d="M111.109 119.029c12.927 0 23.406-10.479 23.406-23.406 0-12.926-10.479-23.406-23.406-23.406s-23.406 10.48-23.406 23.406c0 12.927 10.48 23.406 23.406 23.406z"></path>
